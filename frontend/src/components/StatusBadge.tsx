...
const labels: Record<CompanyStatus | ProjectStatus,string>={active:"Active",inactive:"Inactive",not_started:"Not started",in_progress:"In progress",review:"In review",done:"Done"};
