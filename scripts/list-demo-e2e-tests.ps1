...
try {
    ...
    $manifest = [ordered]@{
        ...
        state = [ordered]@{
            ...
            valid = $fixture; missing = $fixture; mismatch = $fixture; dimensions = $fixture; review = $fixture; approval = $fixture; identity = $fixture; content = $fixture
            identityBrandId = '00000000-0000-4000-8000-000000000005'
        }
